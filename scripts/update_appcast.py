...
def update_appcast(message):
    ...
    release_file = Path(f"release/Microsoft-TTS-Service.bobplugin")
    ...
    version_info = {
        ...
        "desc": message,
        "sha256": file_hash,
        "url": f"https://github.com/markvlenvision/Microsoft-TTS-Service-BobPlugin/releases/download/v{version}/Microsoft-TTS-Service_v{version}.bobplugin",
        "minBobVersion": "0.5.0"
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier="Microsoft-TTS-Service", versions=[])
